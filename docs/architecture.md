...
- **Strata:** discrete layers (UNDERGROUND=0, SURFACE=1, SKY=2) over continuous `(x, y)`; entity `z` is continuous within a stratum band. Full 3D positions, layered 3D world — cheap to simulate, real to render.
